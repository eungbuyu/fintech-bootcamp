...
print(f"The average number of loans is",average_loan_price)
...
print("The Present Value of the loan at discount rate "+str(discount_rate)+" is "+str(round(present_value,2)))
...
for entry in loans:
    loan_price = entry["loan_price"]
    if loan_price <= 500:
        inexpensive_loans.append(entry)    
